...
public class SelectPicPopupWindow extends PopupWindow {
    ...
    public SelectPicPopupWindow(Activity context, View.OnClickListener itemsOnclick) {
        ...
        item_popupwindows_cancel.setBackgroundColor(Color.WHITE);
        item_popupwindows_camera.setBackgroundColor(Color.WHITE);
        item_popupwindows_Photo.setBackgroundColor(Color.WHITE);
        /**
         * 取消按钮销毁事件
         */
        item_popupwindows_cancel.setOnClickListener(view -> dismiss());
